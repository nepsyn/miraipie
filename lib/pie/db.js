...
var Sqlite3Adapter = /** @class */ (function (_super) {
    ...
    Sqlite3Adapter.prototype.loadAppOptions = function () {
        var _a;
        var options = (_a = this.database) === null || _a === void 0 ? void 0 : _a.prepare('SELECT * FROM sys').get();
        if (options) {
            return {
                qq: options.qq,
    ...
    Sqlite3Adapter.prototype.saveMessage = function (record) {
        var _a;
        var resp = (_a = this.database) === null || _a === void 0 ? void 0 : _a.prepare('INSERT INTO message (id, content, from_id, to_id, type) VALUES ($sourceId, $content, $from_id, $to_id, $type)').run({
